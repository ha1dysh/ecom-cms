...
import { CategoryTranslationUpdateFormValidator } from "~/admin/components/categories/Single/CategoryTranslationsForm.validator";
...
export async function updateCategoryTranslation({ productId, formData }: Args) {
